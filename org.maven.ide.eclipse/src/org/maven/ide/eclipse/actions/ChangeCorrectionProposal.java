...
//			Maven2Plugin.log("An exception occurred while applying the Quick Fix", e);
//		}
//	}
    ...
    try {
      ...
      if(change != null) {
        ...
        if(valid.hasFatalError()) {
          IStatus status = new Status(IStatus.ERROR, Maven2Plugin.PLUGIN_ID, IStatus.ERROR, valid
